...
public class UDPClient {
    ...
    static BigInteger p = new BigInteger("294558318881405180764747479252007358319960875235150893513057100495960335262381639732" +
    ...
    public static void main(String[] args) {
        ...
        BigInteger value = g.modPow(a, p);

        System.out.println("value = " + value);
        UDPClient udpClient = new UDPClient();
        udpClient.init("localhost", 7272);
        udpClient.send(String.valueOf(value));
        BigInteger receiveValue = new BigInteger(udpClient.receive());
        System.out.println("Answer: " + receiveValue);
        udpClient.close();
    }
